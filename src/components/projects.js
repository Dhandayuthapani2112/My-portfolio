...
const Projects = () => {
  const projectList = [
    { name: 'Connect Clients & Contractors', github: 'https://github.com/Dhandayuthapani2112/Digital-platform-for-client-and-constructor.git' },
    { name: 'Recruitment Consulting Page', github: 'https://github.com/Dhandayuthapani2112/Recruitment-consulting.git' },
    { name: 'My Portfolio', github: 'https://github.com/project3' },
  ];
