      ...
      <div className="max-w-lg mx-auto bg-white p-8 shadow-lg rounded-lg">
        <div className="mt-8">
          <div className="text-center">
            <img src="/whatsapp.jpg" alt="WhatsApp" className="mx-auto w-32 h-32 mb-2" />
            <p className="text-lg font-bold">+91-9952386487</p>
            <a href="https://wa.me/9952386487" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block">
              Message with Me
            </a>
          </div>
